...
while True:
    print("Welcome to the Digital Empress Database")
    ...
    if user_choice == 1:
        ...
        while num_error:
            ...
            try:
                ...
                print("I dont't recognise that as number")
                num_error = True
...
print("Goodbye and thank you for using the Raspberry Pi", "Digital Empress Database")
